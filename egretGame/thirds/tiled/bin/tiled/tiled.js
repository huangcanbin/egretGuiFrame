    ...
    var TMXHexagonalRenderer = (function (_super) {
        ...
        TMXHexagonalRenderer.prototype.pixelToTileCoords = function (x, y) {
            if (this._staggeraxis === "x")
                x = x - ((this._staggerindex === "odd") ? this._sidelengthx : this.tilewidth);
            else
                y = y - ((this._staggerindex === "odd") ? this._sidelengthy : this.tileheight);
            ...
            var rel = new egret.Point(x - referencePoint.x * (this.tilewidth + this._sidelengthx), y - referencePoint.y * (this.tileheight + this._sidelengthy));
            if (this._staggeraxis === "x") {
