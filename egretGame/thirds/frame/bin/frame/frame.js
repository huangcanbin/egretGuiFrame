...
(function (frame) {
    ...
    (function (layout) {
        ...
        var IDisplay = /** @class */ (function (_super) {
             ...
             * 添加事件
             */
            IDisplay.prototype.outside = function (value) {
                if (this.eyeable) {
                    if (value.root) {
                        value.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onTouchTap, this);
                        value.root.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onRootTouchTap, this);
            ...
            IDisplay.prototype.onAddedToStage = function (event) {
                ...
                this.display.root.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onRootTouchTap, this);
            ...
            IDisplay.prototype.onRemovedFromStage = function (event) {
                ...
                this.display.root.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.onRootTouchTap, this);
